...
d="$(tree desktop)"
printf '%s\n' '2b:00.0 "0300" "10de" "2702" -ra1 -p00 "1458" "4140"' \
	'00:1f.3 "0403" "1022" "1457" -r00 -p00 "1458" "a0cc"' >"$d/lspci.txt"
...
expect 'desktop/devices' '10de:2702' "$(SYSROOT="$d" detect_gpu_devices)"

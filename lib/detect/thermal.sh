...
# names it is assigned in probe order: the k10temp that is hwmon2 on this
# machine is hwmon4 on the next one, and a config that hardcodes one shows
# either nothing or the wrong chip. So the driver name decides, not the index.
#
